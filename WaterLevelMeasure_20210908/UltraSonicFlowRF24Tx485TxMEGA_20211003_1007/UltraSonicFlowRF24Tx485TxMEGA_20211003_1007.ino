...
#define RS485_TX_PIN  18  // A0  // RS485 Driver Input     NANO=A0 / MEGA2560=18
#define RS485_DE_PIN  A6  // RS485 Drive Enable            NANO
#define RS485_RE_PIN  A7  // RS485 Rx Enable (active low)  NANO
#define RS485_RX_PIN  19  // A1  // RS485 Rx Output        NANO=A1 / MEGA2560=19
//#define RS485_TX_PIN  A0  // RS485 Driver Input            NANO
//#define RS485_DE_PIN  A6  // RS485 Drive Enable            NANO
//#define RS485_RE_PIN  A7  // RS485 Rx Enable (active low)  NANO
//#define RS485_RX_PIN  A1  // RS485 Rx Output               NANO
...
long   microsec2 = ultrasonic2.timing();
  ...
  //Serial.print(" Tx=");
  NeoSWSerial.print(send_payload);
  //Serial1.print(send_payload);
